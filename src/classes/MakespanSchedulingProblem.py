...
class MakespanSchedulingProblem(Problem):
    """
    Optimization problem: Allocation of tasks to processes in order to minimize makespan.
    ...
    def __call__(self, tasks):
        ...
        Returns:
            Var[]: Variables list, representing the assignment of tasks to processes
    ...
    def build_variables(self):
        """
        Variables:
        - allocations GRB.BINARY[tasks_size, processes_size]: Matrix representing assignment
          of tasks to processes (1 if task i is assigned to process j, 0 otherwise).
        - c GRB.CONTINUOUS: Variable representing the makespan (maximum load across all processes).
        """
    ...
    def build_criterion(self):
        """
        Criterion: Minimize the makespan (maximum total processing time assigned to any process).
        """
    ...
    def build_constraints(self):
        ...
        - The total processing time assigned to each process must not exceed makespan c.
        """
