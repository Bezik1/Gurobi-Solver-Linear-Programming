...
class KnapsackProblem(Problem):
    """
    Optimization problem: Select items with specific weights and prices to maximize value.
    
    Args:
        prices_size (int): Number of items available (based on price list).
        weights_size (int): Number of items available (based on weight list).
    """
    ...
    def build_variables(self):
        """
        Variables:
        - choosen_items GRB.BINARY[prices_size]: 1 if item i is selected, 0 otherwise.
        """
    ...
    def build_constraints(self):
        """
        Constraints:
        - The total weight of selected items must not exceed the specified capacity.
        """
